...
const NoahArkChallenge = () => {
  ...
  const handleNextQuestion = () => {
    if (currentQuestionIndex < noahArkQuiz.length - 1) {
  ...
  const getScoreMessage = () => {
    ...
    const percentage = (finalScore / noahArkQuiz.length) * 100;
    
    if (percentage >= 90) {
      return "Excellent! You have a great understanding of Noah's story.";
    } else if (percentage >= 70) {
      return "Good job! You have a solid knowledge of the flood narrative.";
    } else if (percentage >= 50) {
      return "Nice effort! You're on your way to understanding this important story.";
    } else {
      return "Keep studying! The story of Noah has so much to teach us about faith and obedience.";
    }
  };
  ...
  if (quizCompleted) {
    const finalScore = correctAnswers + (selectedOption === currentQuestion.correctAnswer ? 1 : 0);
    const percentage = Math.round((finalScore / noahArkQuiz.length) * 100);
        ...
        <div className="glass-card p-8 rounded-xl mb-8">
          <div className="text-center mb-6">
            ...
            <p className="text-xl font-medium">
              You got {finalScore} out of {noahArkQuiz.length} questions correct
            </p>
          </div>
          ...
          <p className="text-center text-bible-dark/70 mb-8">
            The story of Noah teaches us about faith, obedience, and God's plan for salvation through judgment. It foreshadows how God would later save His people through Christ.
          </p>
    ...
    >
      <div className="mb-8">
        ...
        <p className="text-bible-dark/70">
          Test your knowledge of Noah, the flood, and God's covenant.
        </p>
        
        <div className="flex items-center justify-between mt-4">
          <div className="text-sm text-bible-dark/60">
            Question {currentQuestionIndex + 1} of {noahArkQuiz.length}
          </div>
          {correctAnswers > 0 && (
        ...
        <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
          <div 
            ...
            style={{ width: `${((currentQuestionIndex) / noahArkQuiz.length) * 100}%` }}
          ></div>
        </div>
      </div>
      ...
      <div className="glass-card p-6 rounded-xl mb-8">
        ...
        {!isAnswerSubmitted ? (
          ...
          >
            {currentQuestionIndex < noahArkQuiz.length - 1 ? (
              <>
                Next Question
...
export default NoahArkChallenge;
