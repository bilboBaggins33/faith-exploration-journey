          ...
          {!showExplanation ? (
            <motion.button
              ...
              className={cn(
                ...
                selectedAnswer
                  ? "bg-gradient-to-r from-amber-400/90 to-amber-500/90 text-white border-amber-300/50 shadow-xl hover:shadow-2xl"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              className="w-full md:px-8 py-3 rounded-full font-medium bg-gradient-to-r from-amber-400/90 to-amber-500/90 text-white border border-amber-300/50 shadow-xl hover:shadow-2xl transition-all duration-300 relative flex items-center justify-center"
            >
