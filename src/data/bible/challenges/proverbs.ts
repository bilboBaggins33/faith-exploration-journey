    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          'To provide wisdom, instruction, and understanding',
          'To record historical events',
          'To predict the future'
        ],
        correctAnswer: 'To provide wisdom, instruction, and understanding',
      ...
      },
      {
        ...
        options: [
          ...
          'Bad company provides valuable life experience',
          'Do not go along with those who entice you to do wrong',
          'Bad company only affects weak-minded people'
        ],
        correctAnswer: 'Do not go along with those who entice you to do wrong',
      ...
      },
      {
        ...
        options: [
          ...
          'As a woman calling out in public places',
          'As a soldier in battle',
          'As a farmer working in fields'
        ],
    ...
    questions: [
      {
        ...
        options: [
          ...
          'By accepting and treasuring God\'s commands',
          'By asking other people',
          'By trial and error'
        ],
        correctAnswer: 'By accepting and treasuring God\'s commands',
      ...
      },
      {
        ...
        options: [
          'Physical strength',
          'Financial security',
          'Protection from wicked ways and evil people',
          'Political power'
        ],
        correctAnswer: 'Protection from wicked ways and evil people',
      ...
      },
      {
        ...
        correctAnswer: 'The wayward woman',
      ...
      },
      {
        ...
        options: [
          ...
          'The righteous will dwell in the land but the wicked will be uprooted',
          'The wicked will reform eventually',
          'The righteous will face hardship but be rewarded in heaven'
        ],
...
export default proverbsChallenges;
