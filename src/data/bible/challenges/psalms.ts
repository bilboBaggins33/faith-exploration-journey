    ...
    questions: [
      {
        ...
        options: [
          ...
          'They avoid the counsel of the wicked and delight in God\'s law',
          'They are popular and well-respected',
          'They pray at specific times each day'
        ],
        correctAnswer: 'They avoid the counsel of the wicked and delight in God\'s law',
      ...
      },
      {
        ...
        options: [
          ...
          'They are struck down by lightning',
          'They are turned to stone',
          'They are given a second chance'
        ],
        correctAnswer: 'They are like chaff blown away by the wind',
      ...
      },
      {
        ...
        options: [
          ...
          'God knows the way of the righteous but not the wicked',
          'God knows both the way of the righteous and the wicked',
          'God\'s knowledge is limited'
        ],
        correctAnswer: 'God knows both the way of the righteous and the wicked',
    ...
    questions: [
      {
        ...
        correctAnswer: 'The nations and peoples',
      ...
      },
      {
        ...
        options: [
          ...
          'He immediately destroys them',
          'He pleads with them',
          'He ignores them'
        ],
        correctAnswer: 'He laughs and scoffs at them',
      ...
      },
      {
        ...
        correctAnswer: 'He has made him king on Zion',
      ...
      },
      {
        ...
        options: [
          'Build strong armies',
          'Be wise and serve the Lord with fear',
          'Make alliances with other nations',
          'Collect more taxes'
        ],
        correctAnswer: 'Be wise and serve the Lord with fear',
...
export default psalmsChallenges;
