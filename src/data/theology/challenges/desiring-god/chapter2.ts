...
export const chapter2Challenge: TheologyChallenge = {
  id: 'desiring-god-chapter-2',
  bookId: 'desiring-god',
  chapter: 2,
  title: 'Conversion: The Creation of a Christian Hedonist',
  questions: [
    {
      id: 'desiring-god-2-1',
    ...
    },
    {
      ...
      options: [
        ...
        'That self-denial is temporary but leads to eternal joy',
    ...
    },
    {
      ...
      options: [
        ...
        'Satisfaction in God precedes faith',
    ...
    },
    {
      ...
      options: [
        ...
        'Experiencing emotional highs during worship',
    ...
    },
    {
      ...
      options: [
        ...
        'Repentance is turning from lesser joys to ultimate joy in God',
