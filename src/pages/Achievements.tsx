...
const Achievements = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen pb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/10 w-full md:w-auto min-w-[300px]">
              <div className="flex justify-between items-center mb-2">
                <span className="text-white/80 text-sm font-medium">Total Unlocked</span>
                <span className="text-white font-bold text-xl">{unlockedCount} <span className="text-white/40 text-sm font-normal">/ {totalCount}</span></span>
              </div>
              <div className="w-full bg-white/10 rounded-full h-2.5 mb-2">
                <div
                  className="bg-gradient-to-r from-bible-gold to-amber-500 h-2.5 rounded-full transition-all duration-1000"
      ...
      <main className="flex-grow px-4 md:px-6 -mt-8 relative z-20">
        <div className="max-w-7xl mx-auto">
          <Tabs defaultValue="all" className="space-y-8">
            <div className="flex justify-center md:justify-start">
              <TabsList className="bg-white shadow-md p-1 rounded-xl">
                <TabsTrigger value="all" className="rounded-lg data-[state=active]:bg-bible-blue data-[state=active]:text-white">All Awards</TabsTrigger>
                <TabsTrigger value="bible" className="rounded-lg data-[state=active]:bg-bible-blue data-[state=active]:text-white">Bible</TabsTrigger>
                <TabsTrigger value="theology" className="rounded-lg data-[state=active]:bg-bible-blue data-[state=active]:text-white">Theology</TabsTrigger>
                <TabsTrigger value="challenges" className="rounded-lg data-[state=active]:bg-bible-blue data-[state=active]:text-white">Challenges</TabsTrigger>
              </TabsList>
            </div>
